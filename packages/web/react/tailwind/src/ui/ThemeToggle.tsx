...
import { ThemeManager, type Theme } from '@mycomponents/ui-core';
...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({
  ...
  const [themeManager, setThemeManager] = useState<InstanceType<typeof ThemeManager> | null>(null);
  ...
  useEffect(() => {
    ...
    const unsubscribe = manager.onChange((newTheme: Theme) => {
      setTheme(newTheme);
      onChange?.(newTheme);
    });
