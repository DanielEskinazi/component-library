...
import { AudioRecorder as Recorder, AudioRecorderState, AudioData } from '@mycomponents/audio-recorder-core';
import { formatDuration, formatFileSize } from '@mycomponents/audio-recorder-core';
